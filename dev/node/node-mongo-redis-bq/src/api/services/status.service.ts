...
import { StatusMapper } from "src/components/mappers/index.mapper";
...
import { StatusRepository } from "../documents/contracts/status.repository";
...
export class StatusService extends ServiceBase {
    ...
    async create(dto: StatusDto): Promise<any> {
    ...
    async update(uuid: string, dto: StatusDto): Promise<any> {
        try {
