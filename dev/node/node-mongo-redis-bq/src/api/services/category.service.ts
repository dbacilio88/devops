...
import { CategoryMapper } from "src/components/mappers/index.mapper";
...
import { CategoryRepository } from "../documents/contracts/Category.repository";
...
export class CategoryService extends ServiceBase {
    ...
    async update(uuid: string, dto: CategoryDto): Promise<any> {
        try {
